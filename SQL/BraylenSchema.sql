...
p database if exists braylon;create database braylon;use braylon;create table Customer (
		...
		insert into Customer values (1,'Beth', 'Raymond', '123 Main St','123-123-1234','Genesis10','beth@beth.com'),(2,'Joe', 'Gonzalez', '10 Joe Lane','234-123-1245','Joe Gonzalez','Joe@joe.joe');create table `User` (
												...
												create table orderProduct(
													...
													create table SalesVisit (
															salesvisitId int primary key auto_increment,
															    ...
															    foreign key (userId) references User(userId),
															    foreign key (customerId) references Customer(customerId)
														);insert into SalesVisit values (1,'2020-02-12',2,1,'Home','ahhh','1'),(2,'2020-02-14',1,2,'Company','ahhh','2'),(3,'2020-02-16',2,3,'Home','ahhh','3'),(4,'2020-02-17',1,2,'Home','ahhh','4'),(5,'2020-02-18',2,1,'AHOIASFH','ahhh','1');-- select * from Customer;
														-- select * from User;
